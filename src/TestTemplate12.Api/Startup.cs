...
using TestTemplate12.Api.Middlewares;
using TestTemplate12.Application;
...
namespace TestTemplate12.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                var sqlConnectionStringBuilder = new SqlConnectionStringBuilder(_configuration["TestTemplate12DbConnection"] ?? string.Empty);
            ...
            services.AddSwaggerGen(setupAction =>
            {
                ...
                setupAction.SwaggerDoc(
                    "TestTemplate12OpenAPISpecification",
                    new OpenApiInfo
                    {
                        Title = "TestTemplate12 API",
                        Version = "v1",
                        Description = "This API allows access to TestTemplate12.",
                ...
                setupAction.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "TestTemplate12.Api.xml"));
            });
            ...
            services.AddCors(o => o.AddPolicy("TestTemplate12Client", builder =>
            {
            ...
            services.AddMassTransit(x =>
            {
                ...
                x.AddEntityFrameworkOutbox<TestTemplate12DbContext>(o =>
                {
            ...
            services.AddTestTemplate12ApplicationHandlers();
            ...
            services
                .AddHealthChecks()
                .AddDbContextCheck<TestTemplate12DbContext>();
        }
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            //    app.UseHsts();
            // }
            app.UseCors("TestTemplate12Client");
            ...
            app.UseSwaggerUI(c =>
            {
                c.SwaggerEndpoint("/swagger/TestTemplate12OpenAPISpecification/swagger.json", "TestTemplate12 API");
