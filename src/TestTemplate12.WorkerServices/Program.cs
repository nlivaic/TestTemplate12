...
using TestTemplate12.WorkerServices.FaultService;
using TestTemplate12.WorkerServices.FooService;
using LoggerExtensions = SparkRoseDigital.Infrastructure.Logging.LoggerExtensions;

namespace TestTemplate12.WorkerServices
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            {
                Log.Fatal(ex, "TestTemplate12 Worker Services failed at startup.");
            }
            finally
            {
                Log.CloseAndFlush();
