        ...
        IAsyncLifetime
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            builder.ConfigureTestServices(services =>
            {
                ...
                services.Remove(services.SingleOrDefault(d => d.ServiceType == typeof(DbContextOptions<TestTemplate12DbContext>)));
                ...
                var ctx = scopedServices.GetRequiredService<TestTemplate12DbContext>();
        ...
        public TestTemplate12DbContext CreateDbContext(ITestOutputHelper testOutput = null)
        {
        ...
        {
            private readonly DbContextOptions<TestTemplate12DbContext> _options;
            ...
            public TestTemplate12DbContext BuildContext() =>
                new(_options);
        }
    }
}
